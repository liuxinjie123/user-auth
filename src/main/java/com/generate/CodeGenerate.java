...
public class CodeGenerate {
     ...
     * 代码生成位置
     */
    public static final String PARENT_NAME = "com.user.auth";
    ...
    public static final String JDBC_MYSQL_URL = "jdbc:mysql://localhost:3306/mybatis_plus?" +
